...
(1, 'pasito', 'XXX', 'Modernist', 400),
(2, 'vaporesso', 'James Joyce', 'VVV', 600),
(3, 'chicken', 'PPP', 'Novel', 800);
...
(1, 'Dauren', 'QQQ', 'horror', 20),
(2, '007', 'RRR', 'adventure', 18);
...
('Dauren', 'zhaparov965@gmail.com', 'test'),
('XXX', 'test@test.com', 'test');
